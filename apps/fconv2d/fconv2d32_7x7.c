...
void fconv2d32_7x7(float *o, float *i, float *f, int64_t M, int64_t N,
                 int64_t F) {
...
void fconv2d32_7x7_block(float *o, float *i, float *f, int64_t R, int64_t C,
  ...
  float f6, f13, f20, f27, f34, f41, f48;
  ...
  // Load one input row
  asm volatile("vle32.v v0, (%0); add %0, %0, %1" : "+&r"(i_) : "r"(ldi_pad));
  asm volatile("vle32.v v4, (%0); add %0, %0, %1" : "+&r"(i_) : "r"(ldi_pad));
  asm volatile("vle32.v v8, (%0); add %0, %0, %1" : "+&r"(i_) : "r"(ldi_pad));
  asm volatile("vle32.v v12, (%0); add %0, %0, %1" : "+&r"(i_) : "r"(ldi_pad));
