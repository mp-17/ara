...
emit("exponents_f64", exponents_f64, 'NR_LANES*4*NR_CLUSTERS')
emit("results_f64", results_f64, 'NR_LANES*4*NR_CLUSTERS')
emit("gold_results_f64", gold_results_f64, 'NR_LANES*4*NR_CLUSTERS')
emit("N_f32", np.array(N_f32, dtype=np.uint32))
emit("exponents_f32", exponents_f32, 'NR_LANES*4*NR_CLUSTERS')
emit("results_f32", results_f32, 'NR_LANES*4*NR_CLUSTERS')
emit("gold_results_f32", gold_results_f32, 'NR_LANES*4*NR_CLUSTERS')
